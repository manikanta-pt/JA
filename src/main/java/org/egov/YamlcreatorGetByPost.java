...
public class YamlcreatorGetByPost {
	...
	public static void main(String[] args) {
		...
		YamlcreatorGetByPost rc=new YamlcreatorGetByPost();
	...
	private String getReq_RespDef(Class<?> pojo) {
		...
		ss.a(tabCount).a("description: Contract class to receive request. ")
		.a("Array of "+objectSnakecase+" items  are used in case of create . Where as single "+objectSnakecase+" item is used for update").a(NEWLINE);
		//tabCount++;
		...
		tabCount++;
		ss.a(tabCount).a("description: Contract class to send response. ")
		.a("Array of "+objectSnakecase+" items  are used in case of search results or response for create. Where as single "+objectSnakecase+" item is used for update").a(NEWLINE);
		ss.a(tabCount).a("properties:").a(NEWLINE);
		tabCount++;
	...
	private String getGetMethod(String fullyQualifiedName) {
		...
		try {
			...
			jsn.a(tabCount).a("  ").a(TAB).a("$ref: '#/definitions/"+requestPojo.getSimpleName()+"'").a(NEWLINE);
			...
			for(Field f:declaredFields)
			{
				...
				if(Utility.findTypes(f).equals("l"))	
				{
					...
					if(f.getType().isEnum()){
						skip=true;
						jsn.a(tabCount+1).a("- name: ").a(objectSnakecaseName).a(snakeCaseName).a(NEWLINE);
						jsn.a(tabCount+1);
				...
				}else if(f.getName()=="id")
				{
					...
					jsn.a(tabCount+1).a("  ").a("type: integer").a(NEWLINE);
					jsn.a(tabCount).a("  ").a("format: int64").a(NEWLINE);
					skip=true;
	...
	private String getPutMethod(String fullyQualifiedName) {
		...
		try {
			...
			jsn.a(tabCount);
			String uriName = English.plural(pojo.getSimpleName()).toLowerCase();
			jsn.a("/").a(uriName).a("/{id}/_update:").a(NEWLINE);
			tabCount=tabCount+1;
			jsn.a(tabCount).a("post:").a(NEWLINE);
			tabCount=tabCount+1;
