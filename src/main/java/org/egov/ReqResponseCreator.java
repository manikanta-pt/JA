...
public class ReqResponseCreator {
	...
	public static void main(String[] args) {
		...
		rc.create("org.egov.egf.entity.Bank");
	...
	public void create(String fullyQualifiedName)    
	{
		...
		try {
			sqlWriter = new PrintWriter(Utility.SRCFOLDER+"/org/egov/"+Utility.MODULEIDENTIFIER+"/web/contract/"+pojo.getSimpleName()+".java", "UTF-8");
