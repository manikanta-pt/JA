...
public class ControllerCreator {
	...
	public static void main(String[] args) {
		...
		rc.createController("org.egov.tl.domain.entity.FeeMatrix");
	...
	{	
		try {
			...
			.a("private void prepareForNewForm(Model model) {")
			.a(NEWLINE)
			.str());
			...
			.a("create(@Valid @ModelAttribute final "+pojo.getSimpleName()+" "+Utility.toCamelCase(pojo.getSimpleName())
					...
					.a(TAB+"return ")
					.a(pojo.getSimpleName().toUpperCase()+"_RESULT")
					.a(";")
					.a(NEWLINE)
			...
			methods.append(new SB()
			.a("@RequestMapping(value = \"edit/{"+viewField+"}\", method = RequestMethod.POST)"+NEWLINE)
			.a(TAB)
			.a("public String ")
			.a("edit(@PathVariable(\""+viewField+"\") final String "+viewField+"){")
			.a(NEWLINE)
			.a(TAB)
			.a("return ")
			...
			methods.append(new SB()
			.a("@RequestMapping(value = \"view/{"+viewField+"}\", method = RequestMethod.POST)"+NEWLINE)
			.a(TAB)
			.a("public String ")
			.a("view(@PathVariable(\""+viewField+"\") final String "+viewField+"){")
			.a(NEWLINE)
			.a(TAB)
			.a("return ")
